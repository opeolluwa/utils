...
<template>
  <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56 flex flex-col items-center justify-center">
    ...
    <div class="text-center px-8">
      ...
      <p class="mt-6 text-lg leading-8 text-gray-600">
        An efficient tool designed to streamline workflows, boost productivity, and elevate project
        quality with a comprehensive suite of utilities for developers.
      </p>
  ...
  <div class="overflow-hidden py-12 sm:py-32">
